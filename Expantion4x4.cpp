...
Matrix4x4 Expantion4x4::MakeIdentity4x4() {
	Matrix4x4 result;
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			if (i == j) {
...
Matrix4x4 Expantion4x4::MakeTranslateMatrix(const Vector3& translate) {
...
Matrix4x4 Expantion4x4::MakeScaleMatrix(const Vector3& scale) {
	Matrix4x4 result = MakeIdentity4x4();
...
Matrix4x4 Expantion4x4::MakeRotateXMatrix(float radius) {
	Matrix4x4 result = MakeIdentity4x4();
...
Matrix4x4 Expantion4x4::MakeRotateYMatrix(float radius) {
	Matrix4x4 result = MakeIdentity4x4();
...
Matrix4x4 Expantion4x4::MakeRotateZMatrix(float radius) {
	Matrix4x4 result = MakeIdentity4x4();
	result.m[0][0] = float(std::cos(radius));
...
Matrix4x4 Expantion4x4::Multiply(const Matrix4x4& m1, const Matrix4x4& m2) {
	Matrix4x4 result;
	for (int i = 0; i < 4; ++i) {
		for (int j = 0; j < 4; ++j) {
			result.m[i][j] = 0;
...
Matrix4x4 Expantion4x4::MakeAffineMatrix(const Vector3& scale, const Vector3& rotate, const Vector3& translate) {
...
Vector3 Expantion4x4::Transform(const Vector3& vector, const Matrix4x4& matrix) {
	Vector3 result;
...
Matrix4x4 Expantion4x4::MakePrespectiveFovMatrix(float fovY, float aspectRatio, float nearClip, float farClip) {
	Matrix4x4 result = MakeIdentity4x4();
...
Matrix4x4 Expantion4x4::Inverse(const Matrix4x4& m) {
	float det =
...
Matrix4x4 Expantion4x4::MakeViewportMatrix(float left, float top, float width, float height, float minDepth, float maxDepth) {
	Matrix4x4 result = MakeIdentity4x4();
